...
import javax.swing.JOptionPane;
    public class Lab06
   {
       public static void main(String[] args) {
         ...
         Object[] maps = {"tasks1","tasks2","tasks3","lab06ext"};
      ...
      { //go to the wall
       ...
       //Go to the wall, picking up all the beepers (max one beeper per pile).
      ...
      { //go to the wall, pick up all the beepers (max one per pile)
       ...
       //Go to the wall, picking up all the beepers.
      ...
      //Get across the gap (one step wide) and go to the end of the entire row of beepers.
